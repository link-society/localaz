...
| [Monitor Logs](services/monitor-logs/) | `https://127.0.0.1:10005` | HTTP / REST (HTTPS) | &#10060; | Logs ingestion + KQL-subset query |
| [Control plane](services/control-plane/) | `https://127.0.0.1:10006`–`10007` | HTTP / REST (HTTPS) | &#10060; | Entra ID (AAD) + Resource Manager (ARM) |

Blob, Queue and Table deliberately occupy the well-known development storage
ports (`10000`/`10001`/`10002`), so existing dev-storage tooling and connection
